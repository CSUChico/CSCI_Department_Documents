...
{
   \fancyfoot[L]{Standards must be compliant with the CBA and the FPPP.  Conflicts between these standards and the CBA or the FPPP will be resolved pursuant to the CBA and then FPPP.}
}
\fancyhead[L]{CSU, Chico Computer Science Department RTP Standards, Page \thepage\ of \pageref{LastPage}}
